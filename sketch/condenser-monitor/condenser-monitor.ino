...
void loop() {
  ...
  JsonDocument phData;
  JsonDocument conductivityData;
  JsonDocument dissolvedData;
  
  //PH
  phData["phVal"] = pHValue;
  phData["acidPump"] = pHValue > 9;
  phData["alkalinePump"] = pHValue < 6;

  //CONDUCTIVITY
  conductivityData["conductivityVal"] = waterConductivity;
  conductivityData["waterPump"] = waterConductivity > 10000;
